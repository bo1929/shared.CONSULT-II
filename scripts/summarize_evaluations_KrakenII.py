    ...
    if CONT:
        with open(sys.argv[1], "r") as results_file:
            for line in results_file.readlines()[1: ]:
                ls = line.strip().split(",")
                results[ls[1]]["species"][ls[3]] +=1
                results[ls[1]]["genus"][ls[4]] +=1
                results[ls[1]]["family"][ls[5]] +=1
                results[ls[1]]["order"][ls[6]] +=1
                results[ls[1]]["class"][ls[7]] +=1
                results[ls[1]]["phylum"][ls[8]] +=1
                results[ls[1]]["superkingdom"][ls[9]] +=1
        ...
        with open(sys.argv[1], "r") as results_file:
            for line in results_file.readlines()[1: ]:
                ...
                results[bin_genome]["species"][ls[3]] +=1
                results[bin_genome]["genus"][ls[4]] +=1
                results[bin_genome]["family"][ls[5]] +=1
                results[bin_genome]["order"][ls[6]] +=1
                results[bin_genome]["class"][ls[7]] +=1
                results[bin_genome]["phylum"][ls[8]] +=1
                results[bin_genome]["superkingdom"][ls[9]] +=1
